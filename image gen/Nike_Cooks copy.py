...
url_label = ctk.CTkLabel(master = tabview.tab("Tab 1"), text = "Enter Youtube URL below : ")
url_entry1 = ctk.CTkEntry(master = tabview.tab("Tab 1"), width=400 , height=40)
url_label.pack()
url_entry1.pack()

url_label = ctk.CTkLabel(master = tabview.tab("Tab 2"), text = "Enter Youtube URL below : ")
url_entry2 = ctk.CTkEntry(master = tabview.tab("Tab 2"), width=400 , height=40)
url_label.pack()
url_entry2.pack()


mp4dnload_button = ctk.CTkButton(master = tabview.tab("Tab 2"), text = "Download MP4" , command= download_video )
mp3dnload_button = ctk.CTkButton(master = tabview.tab("Tab 1"), text = "Download MP3" , command= download_song )
...
res_combobox = ttk.Combobox(master = tabview.tab("Tab 2"), values=resolutions, textvariable=res_var)
...
progress_label1 = ctk.CTkLabel(master = tabview.tab("Tab 1"), text = "0%")

progress_bar1 = ctk.CTkProgressBar(master = tabview.tab("Tab 1"), width=400)
progress_bar1.set(0)




progress_label2 = ctk.CTkLabel(master = tabview.tab("Tab 2"), text = "0%")

progress_bar2 = ctk.CTkProgressBar(master = tabview.tab("Tab 2"), width=400)
progress_bar2.set(0)


#status
status_label1 = ctk.CTkLabel(master = tabview.tab("Tab 1"), text="")
status_label2 = ctk.CTkLabel(master = tabview.tab("Tab 2"), text="")


user_info_frame =tkinter.LabelFrame(master = tabview.tab("Tab 3"), text="User Information")
...
user_Rev =tkinter.LabelFrame(master = tabview.tab("Tab 3"), text="User Review")
user_Rev.grid(row= 2, column=0, padx=20, pady=10)

review = tkinter.Text(user_Rev , width= 45 , height=10)
review.grid(row = 0 , column= 0 , padx=10 , pady = 10)

terms_frame = tkinter.LabelFrame(master = tabview.tab("Tab 3"), text="Terms & Conditions")
...
button = tkinter.Button(master = tabview.tab("Tab 3"), text = "Enter Data", padx=20, pady=5, command = enter_data)
